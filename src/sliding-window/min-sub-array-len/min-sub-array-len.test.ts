import {minSubArrayLen} from "./min-sub-array-len.me";

test('should return the minimal length of a contiguous subarray of ' +
    'which the sum is greater than or equal to the integer passed ' , () => {
